...
List<OnboardingContents> contents = [
  OnboardingContents(
    ...
    desc:
        " A Mobile App for food centres to donate leftovers, as well as for consumers to request. ",
  ),
  OnboardingContents(
    title: "No more Leftover",
    image: "assets/images/image2.png",
    desc: "There are people who would benefit from getting leftover food.",
  ),
  OnboardingContents(
